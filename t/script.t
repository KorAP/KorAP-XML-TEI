...
# TODO:
#   I would expect this to be identical to Aggressive tokenization, but because it
#   tokenizes a different input, the output differs as well. I don't know if this is intended.
#   -nd
...
$t->attr_is('spanList span#t_67', 'from', 423);
$t->attr_is('spanList span#t_67', 'to', 429);

$t->attr_is('spanList span#t_214', 'from', 1210);
$t->attr_is('spanList span#t_214', 'to', 1213);

$t->element_count_is('spanList span', 231);
