...
subtest 'Check entity replacement' => sub {
  ...
  $t->unzip_xml('CORP/DOC/00001/data.xml')
    ->text_is(
      'text',
      encode_utf8(' Aα≈„▒░▓█╗┐┌╔═─┬╦┴╩╝┘└╚│║┼╬┤╣╠├•ˇčˆ†‡ě€ƒ…‗ıι“„▄‹‘‚—–νœŒωΩ‰φπϖř”ρ›’‘šŠσ□■▪⊂˜™▀ŸžŽ')
    );

  $t->unzip_xml('CORP/DOC/00001/header.xml')
    ->text_is('t\.title', decode_utf8('x α≈α y'));
};
