...
# TODO:
#   This is nearly unusable slow and due to namespaces extremely verbode
...
# xml_is($header_xml, '/*[name()="raw_text"]/@docid', 'GOE/AGA.00000', 'textSigle');
xml_like($data_xml, '/*[name()="raw_text"]/*[name()="text"]', qr!^Campagne in Frankreich 1792.*?uns allein begl.cke\.$!, 'text content');
